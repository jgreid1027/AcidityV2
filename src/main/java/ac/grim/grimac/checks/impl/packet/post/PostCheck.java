package ac.grim.grimac.checks.impl.packet.post;
...
@CheckData(name = "Protocol (A)", configName = "Post", checkTypeTrustFactor = TrustFactorCheckType.PACKET, changeTrustFactor = 3)
