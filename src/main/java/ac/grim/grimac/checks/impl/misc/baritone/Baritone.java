package ac.grim.grimac.checks.impl.misc.baritone;
...
@CheckData(name = "Baritone", checkTypeTrustFactor = TrustFactorCheckType.MISC, changeTrustFactor = 3) // falses a bit with optifine zoom
